          ...
          <div class="max-w-4xl mx-auto">
            <dl class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-2">
              <div class="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                <dt class="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Lignes<br><small>Linenn</small></dt>
              ...
              >
                <dt class="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Distance<br><small>Hed</small></dt>
